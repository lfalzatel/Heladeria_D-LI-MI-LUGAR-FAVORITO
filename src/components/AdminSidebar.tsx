...
export default function AdminSidebar() {
  ...
  const nav = [
    { to: '/admin/dashboard', icon: <Home className="w-5 h-5" />, label: 'Inicio' },
    { to: '/pos',             icon: <MenuSquare className="w-5 h-5" />, label: 'Vender' },
    { to: '/admin/management',icon: <Users className="w-5 h-5" />, label: 'Gestión' },
    { to: '/admin/reports',   icon: <BarChart3 className="w-5 h-5" />, label: 'Reportes' },
    { to: '/cliente/pedidos', icon: <ShoppingCart className="w-5 h-5" />, label: 'Pedidos' },
  ];
